 ...
 *
 * @method  commandRegister(\CharlotteDunois\Livia\Commands\Command $command, \CharlotteDunois\Livia\CommandRegistry $registry)                                                                      Emitted when a command get registered.
 * @method  commandReregister(\CharlotteDunois\Livia\Commands\Command $command, \CharlotteDunois\Livia\Commands\Command $oldCommand, \CharlotteDunois\Livia\CommandRegistry $registry)               Emitted when a command get re-registered.
 * @method  commandUnregister(\CharlotteDunois\Livia\Commands\Command $command, \CharlotteDunois\Livia\CommandRegistry $registry)                                                                    Emitted when a command get unregistered.
